...
MOBIFUN_CLIENT_ID = os.environ.get("REDASH_MOBIFUN_CLIENT_ID", "")
MOBIFUN_CLIENT_SECRET = os.environ.get("REDASH_MOBIFUN_CLIENT_SECRET", "")
MOBIFUN_OAUTH_ENABLED = MOBIFUN_CLIENT_ID and MOBIFUN_CLIENT_SECRET
